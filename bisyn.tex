...
\todo[inline]{Is it important to have the data of two functors $\cC\to \cD$, $\cD\to\cA$, rather than just one functor $\cC\to\cA$? Again, I think this is the approach of Irakli-Piotr.}
...
\subsection{The Adams Spectral Sequence of a Homological Context} \todo[inline]{The material in this section is also covered by Irakli-Piotr I'm pretty sure}
