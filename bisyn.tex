...
\subsection{The $\H$-Adams Spectral Sequence}

Maybe just cite Krause?
...
\subsection{A Tale of Two t-Structures}
...
Our proof of Theorem \ref{thm:taulocal} will proceed first by showing that the site described above forms recovery pair $\tau^{-1}\Syn_{E,F}$ and then by comparing the site in this pair to $\Sp_F^\fp$ via the double realization $\Re^2$.
